            ...
            <div key={index} className='py-4 border-t border-b text-gray-800 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
              ...
              <div className='flex items-start gap-6 text-sm'>
                ...
                <div>
                  ...
                  <p className='mt-1'>Date: <span className='text-gray-800'>{new Date(item.date).toDateString()}</span></p>
                  <p className='mt-1'>Payment: <span className='text-gray-800'>{item.paymentMethod}</span></p>
                </div>
              </div>
